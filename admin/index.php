...
<body>
        ...
        *:focus {
        ...
        <div id="formContent">
            ...
            <img src="../images/logo.png" id="icon" alt="logo" />
            </div>

            <!-- Login Form -->
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Username">
                <input type="text" id="password" class="fadeIn third" name="login" placeholder="Password">
                <input type="button" class="fadeIn fourth" value="Log In" onclick="login();"><br>
                
                <div class="pb-4 d-none" id="showErr">
                    <label class="text-danger">Invalid login credentials</label>
                </div>
